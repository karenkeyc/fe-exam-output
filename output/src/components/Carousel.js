        ...
        <div className="carousel">
          <div className="carousel__container">
            <div className="carousel__caption">
              <span className="carousel__caption-header">サンプルテキスト</span>{" "}
              <br className="carousel__caption-spacer" />
              <span className="carousel__caption-header">
                サンプル ルテキスト
              </span>
              <br className="carousel__caption-spacer" />
              <span className="carousel__caption-header">
            ...
            {/* carousel controls */}
            <label
              className="carousel__control carousel__control--prev control-1"
              htmlFor="carousel-3"
            >
              <img
                className="carousel__arrow-img"
                src={left}
                alt="left_arrow"
              />
            </label>
            <label
              className="carousel__control carousel__control--next control-1"
              htmlFor="carousel-2"
            >
              <img
                className="carousel__arrow-img"
            ...
            <label
              className="carousel__control carousel__control--prev control-2"
              htmlFor="carousel-1"
            >
              <img
                className="carousel__arrow-img"
            ...
            <label
              className="carousel__control carousel__control--next control-2"
              htmlFor="carousel-3"
            >
              <img
                className="carousel__arrow-img"
            ...
            <label
              className="carousel__control carousel__control--prev control-3"
              htmlFor="carousel-2"
            >
              <img
                className="carousel__arrow-img"
            ...
            <label
              className="carousel__control carousel__control--next control-3"
              htmlFor="carousel-1"
            >
              <img
                className="carousel__arrow-img"
