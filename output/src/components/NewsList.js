...
const NewsList = () => {
  ...
  <section className="news">
        ...
        <div className="posts__row">
          <article className="post__container">
            <div className="post__single-container">
              <img className="post__image" src={article_img}   alt="news_photo" />
              <p className="post__date">2019.06.19</p>
              <p className="post__title">
              サンプルテキストサンプル ルテキストサンプルテキストサンプルテキストサンプル ルテキ
              </p>
            </div>
          </article>
          <article className="post__container">
    ...
    <div className="load-more">
      <button className="load-more__button" onClick={loadMore}>LOAD MORE</button>
    </div>
  </section>
  )
}
